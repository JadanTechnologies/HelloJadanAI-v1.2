...
export const mockUsers: User[] = [
    { id: 'user-1', username: 'Jadan', email: 'jadan@example.com', avatar: 'https://picsum.photos/seed/jadan/100/100', isAdmin: true, tasksCompleted: 5, ip: '192.168.1.1', deviceInfo: 'Chrome on macOS', status: 'active', credits: 150, dataBalanceMB: 1024, airtimeBalanceNGN: 500, referralCode: 'JADAN123', referredBy: undefined, referralStats: { count: 2, creditsEarned: 35 }, fraudRisk: 'low', location: { country: 'United States', region: 'New York', city: 'New York City' }, dailyGenerations: { image: 5, video: 1, ad: 2, lastReset: new Date().toISOString() } },
    { id: 'user-2', username: 'Alex', email: 'alex@example.com', avatar: 'https://picsum.photos/seed/alex/100/100', isAdmin: false, tasksCompleted: 12, ip: '10.0.0.5', deviceInfo: 'Safari on iOS', status: 'active', credits: 75, dataBalanceMB: 500, airtimeBalanceNGN: 150, referralCode: 'ALEX456', referredBy: 'user-1', referralStats: { count: 0, creditsEarned: 0 }, fraudRisk: 'low', location: { country: 'Canada', region: 'Ontario', city: 'Toronto' }, dailyGenerations: { image: 10, video: 2, ad: 5, lastReset: new Date(Date.now() - 86400000).toISOString() } }, // Yesterday's reset
    { id: 'user-3', username: 'Sam', email: 'sam@temp-mail.org', avatar: 'https://picsum.photos/seed/sam/100/100', isAdmin: false, tasksCompleted: 2, ip: '172.16.0.10', deviceInfo: 'Edge on Windows', status: 'suspended', credits: 10, dataBalanceMB: 0, airtimeBalanceNGN: 0, referralCode: 'SAM789', referredBy: 'user-1', referralStats: { count: 0, creditsEarned: 0 }, fraudRisk: 'high', location: { country: 'United Kingdom', region: 'England', city: 'London' }, dailyGenerations: { image: 1, video: 0, ad: 0, lastReset: new Date().toISOString() } },
    ...
    { id: 'user-5', username: 'Newbie', email: 'newbie@example.com', avatar: 'https://picsum.photos/seed/newbie/100/100', isAdmin: false, tasksCompleted: 0, ip: '172.16.0.10', deviceInfo: 'Chrome on Android', status: 'active', credits: 20, dataBalanceMB: 0, airtimeBalanceNGN: 0, referralCode: 'NEWBIE11', referredBy: 'user-2', referralStats: { count: 0, creditsEarned: 0 }, fraudRisk: 'medium', location: { country: 'Germany', region: 'Berlin', city: 'Berlin' }, dailyGenerations: { image: 0, video: 0, ad: 0, lastReset: new Date().toISOString() } },
];
